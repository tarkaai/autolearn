...
class AgentSkillGenerationRequest(BaseModel):
    """Request to generate a new skill via consumer agent."""
...
class AgentSkillGenerationResponse(BaseModel):
    """Response from skill generation via consumer agent."""
